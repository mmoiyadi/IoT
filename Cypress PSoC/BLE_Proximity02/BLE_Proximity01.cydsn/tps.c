...
*        Global Variables
***************************************/
uint8                isTpsNotificationPending = YES;
uint8                isTpsNotificationEnabled = NO;
...
{
    isTpsNotificationPending = YES;
    
    switch (*pwrLevel)
    {
    case CYBLE_LL_PWR_LVL_NEG_18_DBM:
        *pwrLevel = CYBLE_LL_PWR_LVL_NEG_18_DBM;
        isTpsNotificationPending = NO;
        break;
    case CYBLE_LL_PWR_LVL_NEG_12_DBM:
        *pwrLevel = CYBLE_LL_PWR_LVL_NEG_18_DBM;
        break;
